...
end1
cat picture-line.pug >> newFile.pug
mv -f newFile.pug  picture-line.pug
...
end3
cat picture-line.scss >> newFile.scss
mv -f newFile.scss picture-line.scss
cd ${fileName}
