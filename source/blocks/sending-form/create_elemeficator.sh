...
end1
cat sending-form.pug >> newFile.pug
mv -f newFile.pug  sending-form.pug
...
end3
cat sending-form.scss >> newFile.scss
mv -f newFile.scss sending-form.scss
cd ${fileName}
