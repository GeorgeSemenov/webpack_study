...
end1
cat sending-screen.pug >> newFile.pug
mv -f newFile.pug  sending-screen.pug
...
end3
cat sending-screen.scss >> newFile.scss
mv -f newFile.scss sending-screen.scss
cd ${fileName}
