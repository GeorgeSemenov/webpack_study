...
end1
cat content-screen.pug >> newFile.pug
mv -f newFile.pug  content-screen.pug
...
end3
cat content-screen.scss >> newFile.scss
mv -f newFile.scss content-screen.scss
cd ${fileName}
