...
end1
cat menu-screen.pug >> newFile.pug
mv -f newFile.pug  menu-screen.pug
...
end3
cat menu-screen.scss >> newFile.scss
mv -f newFile.scss menu-screen.scss
cd ${fileName}
